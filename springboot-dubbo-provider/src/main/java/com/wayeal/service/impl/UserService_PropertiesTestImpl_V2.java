...
@Service(version = "2.0", timeout = 3000, retries = 2, weight = 200, protocol = "protocol1")
public class UserService_PropertiesTestImpl_V2 implements UserService_PropertiesTest {
    ...
    public List<User> findAll() throws InterruptedException {
        ...
        System.out.println("version 2.0 服务被调用了：" + i++ + "次");
